...
curl -L https://github.com/rhysmorgan134/react-carplay/releases/download/v1.0.4/ReactCarplay-1.0.4-armv7l.AppImage --output /home/pi/Desktop/Carplay.AppImage
